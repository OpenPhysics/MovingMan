...
export class MovingManSpriteNode extends Node {
  ...
  private static createFigure(h: number): Node {
    ...
    // ── Ground shadow ─────────────────────────────────────────────────────────
    figure.addChild(
      new Rectangle(-torsoW * 0.7, -shoeH * 0.5, torsoW * 1.4, shoeH * 0.8, {
    ...
    figure.addChild(
      new Rectangle(-0.075 * h - shoeW * 0.55, -shoeH, shoeW, shoeH, {
        fill: SHOE_COLOR,
        cornerRadius: shoeH * 0.5,
      }),
    );
    figure.addChild(
      new Rectangle(0.075 * h - shoeW * 0.45, -shoeH, shoeW, shoeH, {
        fill: SHOE_COLOR,
        cornerRadius: shoeH * 0.5,
      }),
    );
    // toe highlights
    figure.addChild(
      new Rectangle(-0.075 * h - shoeW * 0.45, -shoeH + 2, shoeW * 0.35, 3, {
        fill: "rgba(255,255,255,0.25)",
        cornerRadius: 2,
      }),
    );
    figure.addChild(
      new Rectangle(0.075 * h - shoeW * 0.35, -shoeH + 2, shoeW * 0.35, 3, {
        fill: "rgba(255,255,255,0.25)",
        cornerRadius: 2,
      }),
    );
    ...
    // ── Torso (shirt) ─────────────────────────────────────────────────────────
    figure.addChild(
      new Rectangle(-torsoW / 2, shoulderY, torsoW, torsoH, {
    ...
    figure.addChild(
      new Rectangle(-torsoW / 2 + 4, shoulderY + 5, torsoW * 0.2, torsoH - 10, {
        cornerRadius: 4,
        fill: SHIRT_LITE,
      }),
    );
    ...
    figure.addChild(
      new Line(-torsoW / 2, shoulderY + 0.025 * h, -torsoW / 2 - 0.1 * h, hipY + 0.04 * h, {
        stroke: SKIN_BASE,
        lineWidth: armW,
        lineCap: "round",
      }),
    ...
    figure.addChild(
      new Line(torsoW / 2, shoulderY + 0.025 * h, torsoW / 2 + 0.08 * h, shoulderY + 0.2 * h, {
        stroke: SKIN_BASE,
        lineWidth: armW,
        lineCap: "round",
      }),
    ...
    const headGradient = new RadialGradient(
      ...
      0, // inner centre (highlight offset)
      0,
      headCenterY,
      headRadius, // outer edge
    )
    ...
    // Forehead shine
    figure.addChild(
      new Circle(headRadius * 0.25, {
        x: -headRadius * 0.32,
        y: headCenterY - headRadius * 0.42,
    ...
    // ── Smile ─────────────────────────────────────────────────────────────────
    const smileShape = new Shape().arc(
      0,
