...
export const LIGHT_SURFACE_TEXT_FILL = MovingManColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link MovingManColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: MovingManColors.controlSurfaceColorProperty,
  listFill: MovingManColors.controlSurfaceColorProperty,
  buttonStroke: MovingManColors.panelBorderColorProperty,
  listStroke: MovingManColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: MovingManColors.textColorProperty },
  },
